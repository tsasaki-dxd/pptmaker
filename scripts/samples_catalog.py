...
SAMPLES: list[Sample] = [
    ...
    Sample(
        id="dense_workload_summary",
        figure_type="table",
        title="工数・費用内訳サマリー (高密度)",
        prompt="11 行のプロジェクト工数表 — 要望ごとに小計を分けて記載",
        figure_content={
            "headers": ["要望", "主要工程", "工数(h)", "備考"],
            "rows": [
                ["要望1｜経費精算管理システム", "要件定義〜本番移行（12工程）", "102h", "9月末リリース"],
                ["　1-1 要件定義・ヒアリング", "業務フロー整理", "8h", ""],
                ["　1-2 基本設計", "画面遷移・DB・API設計", "11h", ""],
                ["　1-3 OCR PoC", "エンジン選定・精度検証", "8h", ""],
                ["　1-4〜1-6 コア機能実装", "UI・OCR仕訳・承認WF", "38h", ""],
                ["　1-7〜1-9 周辺機能実装", "CSV出力・マスタ・認証統合", "14h", ""],
                ["　1-10〜1-12 テスト・移行・ドキュメント", "UAT・データ移行・引継ぎ", "23h", ""],
                ["要望2｜年末調整OCR解析ツール", "要件定義〜テスト（9工程）", "52h", "8月末リリース"],
                ["要望3｜AI戦略顧問（月次）", "隔週セッション＋準備", "8h/月 × 5ヶ月 = 40h", "5〜9月継続"],
                ["予備枠（バッファ）", "テスト・移行超過対応等", "8h", "9月"],
                ["合計", "―", "202h（予備含む）", ""],
            ],
        },
        notes="高密度テーブル (11行 = 1スライド上限14行の範囲内)。auto_fit を切って本文サイズ自動調整に切り替えたため、密でも読める。",
    ),
    Sample(
        id="quarterly_v",
    ...
    Sample(
        id="gantt_dense",
        figure_type="gantt",
        title="高密度スケジュール (18 タスク上限)",
        prompt="22 週のプロジェクトを 18 タスクで詳細にガント表示",
        figure_content={
            "total_weeks": 22,
            "tasks": [
                {"label": "1-1 要件定義", "start_week": 0, "end_week": 1, "group": "要望1"},
                {"label": "1-2 基本設計", "start_week": 1, "end_week": 2, "group": "要望1"},
                {"label": "1-3 OCR PoC", "start_week": 2, "end_week": 4, "group": "要望1"},
                {"label": "1-4 UI 試作", "start_week": 4, "end_week": 6, "group": "要望1"},
                {"label": "1-5 OCR 本実装", "start_week": 6, "end_week": 10, "group": "要望1"},
                {"label": "1-6 承認 WF", "start_week": 9, "end_week": 13, "group": "要望1"},
                {"label": "1-7 連携機能", "start_week": 12, "end_week": 16, "group": "要望1"},
                {"label": "1-8 テスト", "start_week": 14, "end_week": 18, "group": "要望1"},
                {"label": "1-9 移行 UAT", "start_week": 17, "end_week": 21, "group": "要望1"},
                {"label": "2-1 要件定義", "start_week": 0, "end_week": 2, "group": "要望2"},
                {"label": "2-2 サンプル収集", "start_week": 1, "end_week": 5, "group": "要望2"},
                {"label": "2-3 帳票分類", "start_week": 4, "end_week": 6, "group": "要望2"},
                {"label": "2-4 抽出ロジック", "start_week": 5, "end_week": 12, "group": "要望2"},
                {"label": "2-5 突合ロジック", "start_week": 9, "end_week": 12, "group": "要望2"},
                {"label": "2-6 結果 UI", "start_week": 10, "end_week": 13, "group": "要望2"},
                {"label": "2-7 精度テスト", "start_week": 13, "end_week": 17, "group": "要望2"},
                {"label": "月次セッション", "start_week": 0, "end_week": 21, "group": "AI 顧問"},
                {"label": "予備バッファ", "start_week": 18, "end_week": 21, "group": "予備"},
            ],
            "milestones": [
                {"label": "要望2 リリース", "week": 17},
                {"label": "要望1 リリース", "week": 21},
            ],
        },
        notes="高密度ガント (18タスク = 1スライド上限)。これを超える場合は blueprint LLM が group ごとに別スライドへ分割します。",
    ),
    Sample(
        id="waterfall_pl",
